...
<?php
include("files/fb_index_file/fb_background_file/index_background.php");
?>
	<LINK REL="SHORTCUT ICON" HREF="files/fb_title_icon/Faceback.ico" />
	<link href="files/fb_index_file/fb_css_file/index_css.css" rel="stylesheet" type="text/css">
    <link href="files/fb_font/font.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="files/fb_index_file/fb_js_file/Registration_validation.js"> </script>
</head>
...
<body>
	...
	<!-- Faceback left part -->
		...
		<!--Left part-->
		<!--Mobile Image-->
	<div style="position:absolute; left:5%; top:35%;"> <img src="files/fb_index_file/fb_image_file/Faceback_map.PNG" width="700" height="275"> </div>
...
<div style="position:absolute;left:60.28%; top:74.8%; font-size:16px; color:#000000">  Birthday:  </div>
 ...
 <!--my_details -->
    ...
    <div style="position:absolute;left:13%;top:75%; z-index:3;"> <img src="files/fb_index_file/fb_background_file/Developer_details/my.jpg" height="165" width="150" style="box-shadow:0px 0px 10px 5px rgb(0,0,0);"> </div>
